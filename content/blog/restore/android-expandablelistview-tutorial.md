...
**getGroupView** is used to return a view which will be drawn for each group item. In this case we are using the simple_expandable_list_item_1 layout which is a part of the SDK.
